...
For performance rules (transform/opacity only, no layout thrashing) see **fixing-motion-performance**. For microinteractions and implementation patterns see **interaction-design**.
