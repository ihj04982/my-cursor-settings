...
description: Fix animation performance (transform/opacity, no layout thrashing). For motion quality see 12-principles-of-animation; for patterns see interaction-design.
---
